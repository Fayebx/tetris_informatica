...
bg = pygame.image.load('black.jpeg').convert()
game_bg = pygame.image.load('black.jpeg').convert()

main_font = pygame.font.SysFont('menlo', 65) #pygame.font.Font('font/font.ttf', 65)
font = pygame.font.SysFont('menlo', 45) #pygame.font.Font('font/font.ttf', 45)
